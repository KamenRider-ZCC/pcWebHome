...
const cn = {
  ...
  keyWords: {
    ...
    stepTxt: '步骤',
    resetSuccessTxt: '重置密码成功',
    loginTxt: '去登陆',
    userRegisterTxt: '用户注册',
    staffRegisterTxt: '员工注册'
  },
  placeholders: {
    defaultHolder: '请输入',
    defaultSelectHolder: '请选择',
    accountHolder: '请输入注册手机号/邮箱',
    passwordHolder: '请输入密码',
    codeHolder: '请输入验证码',
    userNameHolder: '你的用户名',
    companyHolder: '您的公司名称',
    provinceHolder: '请选择省',
    cityHolder: '请选择市',
    districtHolder: '请选择区',
    addressHolder: '请输入详细地址',
    loginPwdHolder: '请输入登录密码',
    loginPwdAgainHolder: '请再次输入登录密码',
    staffIdHolder: '请输入您的工号',
    staffCompanyHolder: '请选择分公司',
    staffDepartmentHolder: '请选择部门',
    staffJobHolder: '请选择职位',
    changePwdHolder: '请设置8位数密码',
    changePwdAgainHolder: '请再次输入密码',
    policyNameHolder: '制度名称',
    entryTimeHolder: '录入时间',
    systemAccountHolder: '系统账号',
    clientNameHolder: '客户名称',
    addressHolder2: '地址',
    telephoneHolder: '座机电话',
    clientType: '客户类型',
    len6Holder: '不超过60字',
    len10Holder: '不超过100字',
    editHolder: '点此编辑提示',
