  ...
  <div class="dashboard-container">
    ...
    <el-row type="flex" justify="center" style="margin-bottom: 24px" @mouseenter.native="clearShow()">
      <div class="listCard card_zhzs">
        ...
        <transition name="el-zoom-in-center">
          <div v-show="show1" class="white_card" @mouseleave="show1 = false" @click="goHref('http://218.90.150.118:10088')">
      ...
      <div class="listCard card_zczx">
        ...
        <transition name="el-zoom-in-center">
          <div v-show="show2" class="white_card" @mouseleave="show2 = false" @click="zczx">
            <div style="margin:85px 32px 32px 40px">
      ...
      <div class="listCard card_zqhd">
        ...
        <transition name="el-zoom-in-center">
          <div v-show="show3" class="white_card" @mouseleave="show3 = false" @click="zqhd()">
            <div style="margin:85px 32px 32px 40px">
      ...
      <div class="listCard card_xmsb">
        ...
        <transition name="el-zoom-in-center">
          <div v-show="show4" class="white_card" @mouseleave="show4 = false" @click="goHref('http://218.90.150.118:16007')">
            <div style="margin:85px 32px 32px 40px">
    ...
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="产业协同平台" name="3">
        <div class="tab3" @click="goHref('https://www.yarnplat.com/')">
          <div class="tabDiv">
            <div style="margin-left:6px;width: 28px; height: 6px;background-color: #D80E19;border-radius: 6px" />
            <p class="tabTitle" style="margin-top: 42px">
              产业协同平台
